...
class TransformersSeqClassifierHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx):
        ...
        if self.setup_config.get("FasterTransformer"):
        ...
        if self.setup_config["save_mode"] == "torchscript":
            ...
            if self.setup_config.get("BetterTransformer"):
                try:
            ...
            if (
                self.setup_config.get("model_parallel")
    ...
    def preprocess(self, requests):
        ...
        for idx, data in enumerate(requests):
            ...
            # preprocessing text for question_answering.
                ...
                dialog_default_context = "i am a user. you are a robot. "
                question_context = ast.literal_eval(input_text)
                question = question_context["question"]
                context = question_context["context"] or dialog_default_context
                inputs = self.tokenizer.encode_plus(
                    question,
                    context,
                    max_length=int(max_length),
    ...
    def inference(self, input_batch):
        ...
        # Handling inference for question_answering.
            ...
            for i in range(num_rows):
                ...
                if len(prediction) == 0 or prediction.startswith('<'):
        ...
        if self.setup_config["mode"] == "text_generation":
            if self.setup_config.get("model_parallel"):
    ...
    def get_insights(self, input_batch, text, target):
        ...
        if self.setup_config.get("captum_explanation"):
